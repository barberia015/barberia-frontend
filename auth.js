...
if (username) {
  if (welcomeMessage) welcomeMessage.textContent = `¡Bienvenido, ${username}!`;
  if (welcomeMessageMobile) welcomeMessageMobile.textContent = `¡Bienvenido, ${username}!`;
...
if (profileIcon && profilePanel) {
  profileIcon.addEventListener("click", (e) => toggleProfilePanel(e, profilePanel));
}
if (profileIconMobile && profilePanelMobile) {
  profileIconMobile.addEventListener("click", (e) => toggleProfilePanel(e, profilePanelMobile));
}
